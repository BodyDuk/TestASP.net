...
namespace FilmWebPortal.Models
{
    public class FilmsDbInitializer : DropCreateDatabaseAlways<FilmsContextcs>
    {
        protected override void Seed(FilmsContextcs context)
        {
            ...
            Actor actor1 = new Actor { Id = 1, FirstName = "Кіано", Age = 23,   LastName = " Рівз "};
            Actor actor2 = new Actor { Id = 2, FirstName = "Харісон", Age = 23, LastName = " Форд "};
            Actor actor3 = new Actor { Id = 3, FirstName = "Арнольд", Age = 23, LastName = " Шварцьнегер"};
            Actor actor4 = new Actor { Id = 4, FirstName = "Кемерон", Age = 23, LastName = " Діаз "};
            Actor actor5 = new Actor { Id = 5, FirstName = "Бен", Age = 23,     LastName = " Афлек "};
            ...
            Film s1 = new Film
            {
                ...
                Actors = new List<Actor>() { actor1, actor2, actor5 },
                Director = director1
            };
            Film s2 = new Film
            {
